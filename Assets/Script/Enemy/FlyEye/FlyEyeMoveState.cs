...
{
    public FlyEyeMoveState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_FlyEye _enemy) : base(_enemyBase, _stateMachine, _animBoolName, _enemy)
    {
    }
