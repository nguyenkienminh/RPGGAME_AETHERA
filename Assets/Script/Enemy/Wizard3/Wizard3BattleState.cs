...
public class Wizard3BattleState : EnemyState
{
    Enemy_Wizard3 enemy;
    Transform player;
    private int moveDir;
    ...
    public Wizard3BattleState(global::Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Wizard3 _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
    }
