...
public class ParentDemoBattleState : EnemyState
{
    ...
    public ParentDemoBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName,Enemy_ParentDemon _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
    }
    ...
    public override void Update()
    {
        ...
        if (enemy.isPlayerDetected())
        {
            ...
            {
                if (canAttack() && enemy.CanFireCarpet())
                {
