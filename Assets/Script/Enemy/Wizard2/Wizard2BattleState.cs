...
public class Wizard2BattleState : EnemyState
{
    Enemy_Wizard2 enemy;
    Transform player;
    private int moveDir;
    ...
    public Wizard2BattleState(global::Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Wizard2 _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        enemy = _enemy;
    }
