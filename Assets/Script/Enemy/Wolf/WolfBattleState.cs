...
namespace Assets.Script.Enemy.Wolf
{
    public class WolfBattleState : EnemyState
    {
        ...
        public WolfBattleState(global::Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Woft _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
        {
            enemy = _enemy;
        }
